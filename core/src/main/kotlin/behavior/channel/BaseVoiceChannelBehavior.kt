...
import dev.kord.voice.DefaultVoiceConnectionBuilder
...
public interface BaseVoiceChannelBehavior : TopGuildChannelBehavior {
     ...
     * @return a [VoiceConnection] representing the connection to this [VoiceChannel].
     */
    @KordVoice
    public suspend fun connect(builder: DefaultVoiceConnectionBuilder.() -> Unit): VoiceConnection {
