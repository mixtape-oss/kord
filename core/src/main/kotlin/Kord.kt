...
import dev.kord.core.gateway.KordGatewayBridge
...
public class Kord(
    ...
    /**
     * The [GatewayBridge] used for creating voice connections.
     */
    public val voiceBridge: GatewayBridge = KordGatewayBridge(this)
