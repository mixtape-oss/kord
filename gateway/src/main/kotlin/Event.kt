...
interface VoiceUpdatePacket {
    val data: DiscordVoicePacketData
}

data class VoiceStateUpdate(override val data: DiscordVoiceState, override val sequence: Int?) : VoiceUpdatePacket, DispatchEvent()
data class VoiceServerUpdate(override val data: DiscordVoiceServerUpdateData, override val sequence: Int?) : VoiceUpdatePacket, DispatchEvent()
